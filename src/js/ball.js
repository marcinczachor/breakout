    ...
    class Ball {
        ...
        paddleCollision() {
            if (this.x >= this.paddle.x && this.x <= this.paddle.x + this.paddle.width) {
                if (this.paddle.y - this.y <= this.radius && this.y + this.dY > this.y) {
                    this.dY = -this.dY;
                }
            }
        }
        ...
        horizontalCollision() {
            if (this.x + this.dX > board.width - this.radius || this.x + this.dX < 0 + this.radius) {
                this.dX = -this.dX;
            }
        }
        ...
        verticalCollision() {
            if (this.y + this.dY < 0 + this.radius) {
                this.dY = -this.dY;
            } else if (this.y + this.dY > board.height - this.radius && !(this.x >= this.paddle.x && this.x <= this.paddle.x + this.paddle.width)) {
                this.settings.lives--;
