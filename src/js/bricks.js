...
const bricks = (function () {
    ...
    let wallOfBricks = Array(5).fill().map(cell => Array(3).fill(null));
    ...
    class BrickWall {
        ...
        drawBricks() {
            ...
            this.wall.map((array, i) => array.map((cell, j) => {
        ...
        setNewLevel() {
            ...
            if (level * 150 === score) {
                ...
                this.ball.dY = (this.ball.dY < 0) ? -this.ball.dY + 2.5 : this.ball.dY + 2.5;
        ...
        detectColision() {
            ...
            this.wall.map((array, i) => array.map((cell, j) => {
                if (this.wall[i][j].status === 1) {
                    ...
                    if (this.ball.x > brick.x && this.ball.x < brick.x + width && this.ball.y > brick.y && this.ball.y < brick.y + height) {
